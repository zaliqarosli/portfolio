...
export default function Footer() {
  return (
    <footer className='flex pt-[3.75rem] px-[2.5rem] pb-[2.5rem] flex-col justify-center items-end self-stretch w-full absolute bottom-0'>
      <div className='flex flex-col items-end'>
        <div className='flex flex-col items-start gap-[2.75rem] self-stretch'>
          <div className='flex flex-col items-end gap-[1rem]'>
            <h3 className='flex pl-[0.3125rem] content-center items-center'>
              get in touch
            </h3>
