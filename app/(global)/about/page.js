  ...
  return (
    <>
      ...
      >
        ...
        <div
          id='timeline'
          className='flex max-w-[54rem] py-[1.25rem] pr-[0.625rem] flex-col content-center items-start self-stretch'
        ></div>
        <div
          id='cta-group-2'
          className='flex max-w-[54rem] pt-[4.375rem] flex-col items-end gap-[1.25rem]'
        >
